...
export async function POST(request: NextRequest, { params }: { params: { id: string } }) {
  ...
  try {
    ...
    const { bloodgroup, Epilepsy,BleedingTendency, Diabetics,Hypotension,Hepatitis,Tuberculosis,Astema,description,weight, height, Medication, allergies, habits, Core_Temperature, Respiratory_Rate, Blood_Oxygen, Blood_Pressure, heart_Rate } = await request.json();
    console.log("Received Payload:", {
      ...
      Hypotension,Tuberculosis,Astema,description
    });
    ...
    const newHealthinfo = new HealthinfoModel({
      ...
      patientId: { id: patient._id }, // Direct reference
      createdBy: {
        id: user.id,
