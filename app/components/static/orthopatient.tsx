  ...
  return (
    <div className="flex-1 ml-60">
      <div className="mt-16 p-6">
        <h1 className="text-3xl font-extrabold text-center text-gray-800 mb-6">Orthodontics Patients</h1>
        <div className="text-left">
          <a href="/admin/Paradoni" className="mb-5 py-2 px-4 inline-block">
            <Button type="button" className="bg-gray-300 px-4 py-2 rounded">Prosthodontics</Button>
          </a>
          <a href="/admin/DiseaseReport" className="mb-5 py-2 px-4 inline-block">
            <Button type="button" className="bg-gray-300 px-4 py-2 rounded">Disease Report</Button>
          </a>
          <a href="/admin/patienOrg" className="mb-5 py-2 px-4 inline-block">
            <Button type="button" className="bg-gray-300 px-4 py-2 rounded">Credit Report</Button>
          </a>
        </div>
