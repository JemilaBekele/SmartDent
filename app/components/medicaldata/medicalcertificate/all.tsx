...
export default function CertificatePage({ params }: CertificatePageProps) {
  ...
  // Y position for image
    ...
    doc.text("Email: Allethio123@gmail.com ", 105, footerY + 15, {
      align: "center",
    });
    doc.text("Address: Lideta sub-city Wereda 08 AIA Building H.No-new/216 Addis Ababa,Ethiopia", 105, footerY + 20, {
      align: "center",
    });
